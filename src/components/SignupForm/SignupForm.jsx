    ...
    return (
      <div className='background'>
        ...
        <form className="form-horizontal" onSubmit={this.handleSubmit} >
          ...
          <Col s={12}offset="s3">          
            <Input s={9} m={6} type="password" className="form-control" placeholder="Confirm Password" autocomplete='off' value={this.state.passwordConf} onChange={(e) => this.handleChange('passwordConf', e)} />
          </Col>            
          <Col s={12}>
